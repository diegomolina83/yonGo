    ...
    render() {
        return (
            ...
            <Container fluid='lg' className='py-5'>
                ...
                <h1 className='mb-5 text-center font-weight-bold'>Go for a new experience!</h1>

                <Form className='plan-form' onSubmit={this.handleFormSubmit}>

                    <Form.Group>
                        <Form.Control className='bg-secondary text-white plan-form-title' required type="text" name="title" value={this.state.title} onChange={this.handleInputChange} placeholder='Titulo' />
                    ...
                    <Form.Group className='px-3 pt-3 border rounded bg-light'>
                        ...
                        <Form.Group>
                            <Form.Control type="text" name="startLocation" value={this.state.length} onChange={this.handleInputChange} placeholder='Location' />
                        </Form.Group>
                    ...
                    <Form.Group className='px-3 pt-3 border rounded bg-light'>
                        ...
                        <Form.Group>
                            <Form.Control type="text" name="endLocation" value={this.state.length} onChange={this.handleInputChange} placeholder='Location' />
                        </Form.Group>
                        ...
                        <Row>
                            ...
                            <Col>
                                <Form.Group>
                                    <Form.Control type="time" name="endHour" value={this.state.inversions} onChange={this.handleInputChange} />
                                </Form.Group>
                            </Col>
                        </Row>
                    ...
                    <Form.Group>
                        ...
                        <Form.Label className='d-block'>Alcance</Form.Label>

                        <ButtonGroup className='border rounded' aria-label="scope">
                            <Button id='public' variant={this.props.styles.button.default} onClick={this.handleOptionChange}>Public</Button>
                            <Button id='friends' variant={this.props.styles.button.active} onClick={this.handleOptionChange}>Friends</Button>
                            <Button id='group' variant={this.props.styles.button.default} onClick={this.handleOptionChange}>Group</Button>
                        </ButtonGroup>
                    ...
                    <Form.Group>
                        ...
                        <ButtonGroup className='border rounded' aria-label="category">
                            <Button id='sport' variant={this.props.styles.button.default} onClick={this.handleOptionChange} >Deporte</Button>
                            <Button id='culinary' variant={this.props.styles.button.default} onClick={this.handleOptionChange} >Culinary</Button>
                    ...
                    <Form.Group controlId="exampleForm.ControlTextarea1">
                        ...
                        <Form.Control as="textarea" rows="3" name='description' onChange={this.handleInputChange} placeholder='¿Con que vas a deleitar al mundo?' />
                    </Form.Group>
                    ...
                    <Button variant={this.props.styles.button.cancel}>Cancelar</Button>
                </Form>
