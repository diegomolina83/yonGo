...
import FollowButton from '../../../shared/follow_btn/FollowButton'
                                    ...
                                    <Row className='mb-3 justify-content-center justify-content-sm-start'>
                                        ...
                                        <Col xs='auto' className='d-flex align-items-center'>
                                            ...
                                            {user._id === loggedInUser._id ?
                                                ...
                                                <Link to={`/user/settings/${loggedInUser._id}`} style={{ color: 'black' }}>
                                                ...
                                                <FollowButton variant='lightBlue' size='sm' targetUserId={user._id} loggedInUserId={loggedInUser._id}>Follow</FollowButton>
                                            }
